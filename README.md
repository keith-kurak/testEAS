...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/wUYaYwObRw)
...
```sh
npx nx serve testEAS
```

To create a production bundle:

```sh
npx nx build testEAS
```

To see all available targets to run for a project, run:

```sh
npx nx show project testEAS
```
